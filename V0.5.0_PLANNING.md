...
1. **Container Creation UI:** Wizard (step-by-step) or single form?
2. **Compose Editor:** Inline editing or upload-only?
3. **Volume Browser:** Which file types to preview (text, images)?
4. **Alerts:** Email, Discord, ntfy, or webhook only?
5. **Historical Metrics:** Retention period (7 days, 30 days)?
6. **User Permissions:** Role-based or resource-based ACLs?
